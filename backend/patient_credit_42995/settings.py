"""
Django settings for patient_credit_42995 project.
...
ROOT_URLCONF = 'patient_credit_42995.urls'
...
WSGI_APPLICATION = 'patient_credit_42995.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_credit_42995 API",
    "DESCRIPTION": "API documentation for patient_credit_42995 App",
    "VERSION": "v1",
}
